...
public class InvalidRequestException extends BaseException {
	 ...
	 * @param builder
	 */
	private InvalidRequestException(final Builder builder) {
		super();
	 ...
	 * @param builder
	 */
	private InvalidRequestException(final String message, final Builder builder) {
		super(message);
		this.setBuilder(builder);
	}
	 ...
	 * @param builder
	 */
	private InvalidRequestException(final String message, final Throwable cause, final Builder builder) {
		super(message, cause);
		this.setBuilder(builder);
	}
	 ...
	 * @param builder
	 */
	private InvalidRequestException(final Throwable cause, final Builder builder) {
		super(cause);
		this.setBuilder(builder);
	}
	 ...
	 * @param errorCode
	 */
	public InvalidRequestException(final String message, final String errorCode) {
		super(message);
	 ...
	 * @param builder
	 */
	public InvalidRequestException(final String message, final String errorCode, final String forwardUrl) {
		super(message);
		this.errorCode = errorCode;
	 ...
	 * subclasses of <code>InvalidRequestException</code> that might be thrown
	...
	public static class Builder {
		...
		public InvalidRequestException build() {
			if (this.message != null && this.cause != null) {
				return new InvalidRequestException(this.message, this.cause, this);
			} else if (this.message != null) {
				return new InvalidRequestException(this.message, this);
			} else if (this.cause != null) {
				return new InvalidRequestException(this.cause, this);
			} else {
