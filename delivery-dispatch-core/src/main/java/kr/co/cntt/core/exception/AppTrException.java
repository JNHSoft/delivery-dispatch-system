...
public class AppTrException extends BaseTrException {
	/** default serial ID */
	 ...
	 * subclasses of <code>AppTrException</code> that might be thrown
	...
	public static class Builder {
		 ...
		 * 
		 * @return AppTrException class
		 */
		public AppTrException build() {
			if (this.message != null && this.cause != null) {
				return new AppTrException(this.message, this.cause, this);
			} else if (this.message != null) {
				return new AppTrException(this.message, this);
			} else if (this.cause != null) {
				return new AppTrException(this.cause, this);
			} else {
				return new AppTrException(this);
			}
		}
	}
	 ...
	 * @param builder
	 */
	private AppTrException(final Builder builder) {
		super();
	 ...
	 * @param builder
	 */
	private AppTrException(final String message, final Builder builder) {
		super(message);
		this.setBuilder(builder);
	}
	 ...
	 * @param builder
	 */
	private AppTrException(final String message, final Throwable cause, final Builder builder) {
		super(message, cause);
		this.setBuilder(builder);
	}
	 ...
	 * @param builder
	 */
	private AppTrException(final Throwable cause, final Builder builder) {
		super(cause);
		this.setBuilder(builder);
	}
	 ...
	 * @param errorCode
	 */
	public AppTrException(final String message, final String errorCode) {
		super(message);
		this.errorCode = errorCode;
	}
	 ...
	 * @param builder
	 */
	public AppTrException(final String message, final String errorCode, final String forwardUrl) {
		super(message);
		this.errorCode = errorCode;
		this.forwardUrl = forwardUrl;
	}
