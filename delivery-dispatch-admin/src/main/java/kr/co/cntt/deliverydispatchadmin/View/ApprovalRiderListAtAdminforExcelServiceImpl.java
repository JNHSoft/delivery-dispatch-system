...
@Component("ApprovalRiderListAtAdminforExcelServiceImpl")
public class ApprovalRiderListAtAdminforExcelServiceImpl extends ExcelComm {
    @Override
    protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        if (request.getRequestURI().matches("/excelDownloadApprovalRiderListforAdmin")){
            ...
            fileName += "_RiderApprovalList_Admin.xlsx";
        }
