...
//                        log.info("-----------------------------------------------------");
    ...
    public int postOrder(Order order) throws AppTrException {
        ...
        if(storeDTO.getAssignmentStatus().equals("2")){
            storeDTO.getSubGroup().getGroupId();
            Notification noti = new Notification();
            noti.setType(Notification.NOTI.ORDER_NEW);
//            "f7leV43zlcY:APA91bF7kjApgp9AMEG5gk6QcsI6QzY6cERP1xs0r_NUxtFNn_XfCF0fn6lGo7BeJe2KJH6ryXv7EfgYaf6JgQVoFfvyInS4aht6Mmw2-puIIL32QTsHVj8C-Y7JtQMl1Jom8OeBSeur"
