...
//				"/**/*.favicon.ico"
			...
			.antMatchers("/API/v1/getToken.do").permitAll()
			.antMatchers("/API/v1/putToken.do").permitAll()
			.antMatchers("/API/v1/versionCheck.do").permitAll()
			.antMatchers("/API/v1/getSignUpDefaultInfo.do").permitAll()
			.antMatchers("/API/v1/postRiderApproval").permitAll()
			.antMatchers("/API/v1/getCheckRiderApproval").permitAll()
			.antMatchers("/API/v1/sendApplySMS").permitAll()
			.antMatchers("/API/v1/checkApplySMS").permitAll()
